...
const Page = () => {
  ...
  return (
    <div>
      <SidebarLayout>
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-6">Driver License Details</h1>
            ...
            <Card className="md:col-span-2">
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {new Date(
                      userData.dl_details.issue_date
                    ).toLocaleDateString()}
                  </p>
                </div>
                <div>
            ...
            <Card className="md:col-span-2">
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{userData.vehicle.color}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">
                    Registration Expiry
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              <p className="font-medium">{userData.challan.challan_status}</p>
            </div>
            <div>
